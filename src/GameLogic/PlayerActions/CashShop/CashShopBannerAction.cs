...
public class CashShopBannerAction
{
    ...
    public async ValueTask SetBannerAsync(Player player)
    {
        await player.InvokeViewPlugInAsync<ICashShopBannerPlugIn>(p => p.CashShopBannerAsync(583, 2011, 001)).ConfigureAwait(false);
    }
}