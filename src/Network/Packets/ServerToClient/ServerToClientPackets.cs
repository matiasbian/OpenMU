...
/// </summary>
public readonly struct CashShopInit
{
    private readonly Memory<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="CashShopInit"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public CashShopInit(Memory<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private CashShopInit(Memory<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    /// <summary>
    /// Performs an implicit conversion from a Memory of bytes to a <see cref="CashShopInit"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator CashShopInit(Memory<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="CashShopInit"/> to a Memory of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Memory<byte>(CashShopInit packet) => packet._data; 
}


/// <summary>
/// Is sent by the server when: Get cash shop points.
/// Causes reaction on client side: Got cash shop points.
/// </summary>
public readonly struct CashShopPoint
{
    private readonly Memory<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="CashShopPoint"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public CashShopPoint(Memory<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private CashShopPoint(Memory<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    /// <summary>
    /// Performs an implicit conversion from a Memory of bytes to a <see cref="CashShopPoint"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator CashShopPoint(Memory<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="CashShopPoint"/> to a Memory of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Memory<byte>(CashShopPoint packet) => packet._data; 
}
...
/// </summary>
public readonly struct CashShopOpen
{
    private readonly Memory<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="CashShopOpen"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public CashShopOpen(Memory<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private CashShopOpen(Memory<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    /// <summary>
    /// Performs an implicit conversion from a Memory of bytes to a <see cref="CashShopOpen"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator CashShopOpen(Memory<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="CashShopOpen"/> to a Memory of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Memory<byte>(CashShopOpen packet) => packet._data; 
}


/// <summary>
/// Is sent by the server when: Get cash shop storage info.
/// Causes reaction on client side: Got cash shop storage info.
/// </summary>
public readonly struct CashShopStorage
{
    private readonly Memory<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="CashShopStorage"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public CashShopStorage(Memory<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private CashShopStorage(Memory<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    /// <summary>
    /// Performs an implicit conversion from a Memory of bytes to a <see cref="CashShopStorage"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator CashShopStorage(Memory<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="CashShopStorage"/> to a Memory of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Memory<byte>(CashShopStorage packet) => packet._data; 
}
...
/// </summary>
public readonly struct CashShopScript
{
    private readonly Memory<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="CashShopScript"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public CashShopScript(Memory<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private CashShopScript(Memory<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    /// <summary>
    /// Performs an implicit conversion from a Memory of bytes to a <see cref="CashShopScript"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator CashShopScript(Memory<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="CashShopScript"/> to a Memory of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Memory<byte>(CashShopScript packet) => packet._data; 
}


/// <summary>
/// Is sent by the server when: Get cash shop storage items.
/// Causes reaction on client side: Got cash shop storage items.
/// </summary>
public readonly struct CashShopItem
{
    private readonly Memory<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="CashShopItem"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public CashShopItem(Memory<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private CashShopItem(Memory<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    /// <summary>
    /// Gets or sets the product seq.
    /// </summary>
    public uint ProductSeq
    {
        get => ReadUInt32LittleEndian(this._data.Span[16..]);
        set => WriteUInt32LittleEndian(this._data.Span[16..], value);
    }
    ...
    /// <summary>
    /// Gets or sets the price seq.
    /// </summary>
    public uint PriceSeq
    {
        get => ReadUInt32LittleEndian(this._data.Span[20..]);
        set => WriteUInt32LittleEndian(this._data.Span[20..], value);
    }
    ...
    /// <summary>
    /// Performs an implicit conversion from a Memory of bytes to a <see cref="CashShopItem"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator CashShopItem(Memory<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="CashShopItem"/> to a Memory of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Memory<byte>(CashShopItem packet) => packet._data; 
}
...
/// </summary>
public readonly struct CashShopBanner
{
    private readonly Memory<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="CashShopBanner"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public CashShopBanner(Memory<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private CashShopBanner(Memory<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    /// <summary>
    /// Performs an implicit conversion from a Memory of bytes to a <see cref="CashShopBanner"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator CashShopBanner(Memory<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="CashShopBanner"/> to a Memory of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Memory<byte>(CashShopBanner packet) => packet._data; 
}
